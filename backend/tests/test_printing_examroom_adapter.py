...
def test_load_examroom_data_for_exam_bag_supports_subject_mode_counts() -> None:
    arrangement = SimpleNamespace(
        ...
        arranged_students=pd.DataFrame(
            [
                {"姓名": "张三", "考场号": "001", "考场": "第一考场", "首选": "物理", "再选1": "化学", "再选2": "生物"},
                {"姓名": "李四", "考场号": "001", "考场": "第一考场", "首选": "历史", "再选1": "政治", "再选2": "地理"},
                {"姓名": "王五", "考场号": "001", "考场": "第一考场", "首选": "物理", "再选1": "政治", "再选2": "地理"},
            ]
        ),
...
def test_load_examroom_data_for_exam_bag_keeps_fixed_subject_order_across_rooms() -> None:
    arrangement = SimpleNamespace(
        ...
        arranged_students=pd.DataFrame(
            [
                {"姓名": "张三", "考场号": "001", "考场": "第一考场", "首选": "物理", "再选1": "政治", "再选2": "地理"},
                {"姓名": "李四", "考场号": "001", "考场": "第一考场", "首选": "历史", "再选1": "政治", "再选2": "地理"},
                {"姓名": "王五", "考场号": "002", "考场": "第二考场", "首选": "物理", "再选1": "化学", "再选2": "生物"},
            ]
        ),
        _get_room_list=lambda: ["001", "002"],
        _get_room_name=lambda room: {"001": "第一考场", "002": "第二考场"}[str(room)],
